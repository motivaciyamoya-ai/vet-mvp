      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1 text-sm sm:text-base max-w-2xl">
            Поиск по email и имени, роли и профиль. Баланс VetCoin в таблице; в карточке пользователя можно изменить баланс с подтверждением вашим паролем администратора. Массовые операции — в разделе «VetCoin».
          </p>
        </div>
      </div>
            ...
            <div className="p-5 sm:p-6 space-y-5">
              <div className="rounded-xl border border-amber-200/80 bg-gradient-to-br from-amber-50 to-orange-50/60 p-4 space-y-3">
                ...
                <p className="text-xs text-amber-900/90 leading-relaxed">
                  ...
                  записывается в журнал начислений. Подтвердите <strong>своим паролем администратора</strong>.
                </p>
