                ...
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-green-800">
                      ...
                      <p>
                        После регистрации доступен вход в личный кабинет. На указанную почту можно отправить ссылку для
                        подтверждения (в тестовом режиме ссылка дублируется в консоли сервера). Бонус за регистрацию
                        начисляет сервер через VetCoin из настроек админки.
                      </p>
                    </div>
                  </div>
                </div>
