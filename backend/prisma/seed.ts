...
async function main() {
  ...
  const forumDemosBySlug: Record<string, { title: string; tags: string; body: string }> = {
    ...
    dental: {
      title: 'Ветеринарная стоматология: профилактика и лечение зубов у собак и кошек',
      tags: 'стоматология,зубы,профилактика',
      body:
        'Раздел «Стоматология». Обсуждаем индексы зубного налёта, сроки профилактики и подходы к лечению без идентификации пациента. Комментарии коллег приветствуются.',
    },
    dermatology: {
      title: 'Дерматология мелких домашних: зуд, аллергия, пиодермия — темы и комментарии',
      tags: 'дерматология,аллергия,зуд',
      body:
        'Раздел «Дерматология». Делимся алгоритмами диффдиагностики и опытом терапии. Помните о конфиденциальности и локальных протоколах.',
    },
    ophthalmology: {
      title: 'Офтальмология: красный глаз, травмы, давление — обсуждения для ветеринарных офтальмологов',
      tags: 'глаза,офтальмология,травма',
      body:
        'Раздел «Офтальмология». Фокус на клинически значимых признаках и безопасных формулировках для владельцев.',
    },
    cardiology: {
      title: 'Кардиология: шумы, ЭхоКГ и хроническая сердечная недостаточность у питомцев',
      tags: 'кардиология,эхокг,сердце',
      body:
        'Раздел «Кардиология». Обмен кейсами и литературой; решения принимает лечащий врач с учётом законодательства.',
    },
    infectious: {
      title: 'Инфекции и эпиднадзор: карантин, вакцинация, коммуникация с владельцем',
      tags: 'инфекции,карантин,вакцинация',
      body:
        'Раздел «Инфекции и эпиднадзор». Обсуждаем наблюдаемые тенденции и регламенты без персональных данных.',
    },
    reproduction: {
      title: 'Репродукция и акушерство: вязка, роды, послеродовый период — ветеринарный форум',
      tags: 'репродукция,роды,акушерство',
      body:
        'Раздел «Репродукция». Учебные сценарии; экстренные случаи — по правилам вашей клиники и закона.',
    },
    'exotics-birds': {
      title: 'Экзотические животные и птицы: содержание, диета и типичные ошибки владельцев',
      tags: 'экзоты,птицы,содержание',
      body:
        'Раздел «Экзотические и птицы». Специфика метаболизма и стресса; делимся проверенными educational-материалами.',
    },
    farm: {
      title: 'Фермерские животные: профилактика, оборот стада, взаимодействие с госветслужбой',
      tags: 'ферма,крс,профилактика',
      body:
        'Раздел «Фермерские животные». Региональные нормы могут отличаться — указывайте страну в комментариях.',
    },
    endocrine: {
      title: 'Эндокринология: сахарный диабет, щитовидка, болезни надпочечников у собак и кошек',
      tags: 'эндокринология,диабет,щитовидка',
      body:
        'Раздел «Эндокринология и обмен». Лабораторные тренды и интерпретация без персональных данных пациента.',
    },
    orthopedics: {
      title: 'Ортопедия и травма: переломы, дисплазии, реабилитация после операций',
      tags: 'ортопедия,перелом,реабилитация',
      body:
        'Раздел «Ортопедия и травма». Рентген/КТ обсуждаем в обезличенном виде; соблюдаем этику сообщества.',
    },
    oncology: {
      title: 'Онкология мелких животных: стадирование, химиотерапия, качество жизни пациента',
      tags: 'онкология,химиотерапия,качество жизни',
      body:
        'Раздел «Онкология». Образовательный контент; терапевтические решения остаются за клиническим врачом.',
    },
    'icu-emergency': {
      title: 'Неотложка и ICU: стабилизация, мониторинг, алгоритмы для ветеринарных реаниматологов',
      tags: 'icu,реанимация,неотложка',
      body:
        'Раздел «Неотложка и ICU». Обмен чек-листами и оборудованием; без рекламы без согласования.',
    },
    nutrition: {
      title: 'Кормление и рационы: BARF, диеты при заболеваниях, переход между кормами',
      tags: 'питание,рацион,barf',
      body:
        'Раздел «Кормление и рационы». Ссылки на исследования приветствуются; избегаем дискуссий «единственно верный» рацион.',
    },
    'legal-practice': {
      title: 'Юриспруденция и клиника: договоры, документы, GDPR и работа с отзывами',
      tags: 'юриспруденция,документы,клиника',
      body:
        'Раздел «Юриспруденция и клиника». Общие принципы; за юридической консультацией — к профильному специалисту.',
    },
  };
